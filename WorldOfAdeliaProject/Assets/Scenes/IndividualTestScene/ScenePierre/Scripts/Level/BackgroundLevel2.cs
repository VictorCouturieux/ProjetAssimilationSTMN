...
public class BackgroundLevel2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject smallObj = Instantiate(SmallBackgroundObjectList[2], new Vector3(Random.Range(-200, -100), Random.Range(100, 150), 117), Quaternion.Euler(new Vector3(0, 270, 90)));
        smallObj.transform.parent = background.transform;

        GameObject smallObj2 = Instantiate(SmallBackgroundObjectList[3], new Vector3(Random.Range(-50, -50), Random.Range(300, 400), 117), Quaternion.Euler(new Vector3(0, 270, 90)));
        smallObj2.transform.parent = background.transform;
        
        GameObject smallObj3 = Instantiate(SmallBackgroundObjectList[4], new Vector3(Random.Range(100, 200), Random.Range(500, 600), 103), Quaternion.Euler(new Vector3(0, 270, 90)));
